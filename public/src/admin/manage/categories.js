...
define('admin/manage/categories', ['translator', 'benchpress', 'categorySelector', 'api', 'Sortable', 'bootbox', 'alerts'], function (translator, Benchpress, categorySelector, api, Sortable, bootbox, alerts) {
                ...
                api
                    ...
                    .then(() => {
                        ...
                        $(categoryEl)
                            ...
                            .first()
                            .translateText(disabled ? '[[admin/manage/categories:enable]]' : '[[admin/manage/categories:disable]]');
                    })
                    .catch(alerts.error)
            )
        );
