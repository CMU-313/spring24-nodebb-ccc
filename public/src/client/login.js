                ...
                formEl.ajaxSubmit({
                    ...
                    error: function (data) {
                        ...
                        if (data.status === 403 && data.responseText === 'Forbidden') {
                            ...
                            message = errInfo.banned_until ? translator.compile('error:user-banned-reason-until', new Date(errInfo.banned_until).toLocaleString(), errInfo.reason) : '[[error:user-banned-reason, ' + errInfo.reason + ']]';
                        }
