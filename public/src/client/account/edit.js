...
define('forum/account/edit', ['forum/account/header', 'accounts/picture', 'translator', 'api', 'hooks', 'bootbox', 'alerts'], function (header, picture, translator, api, hooks, bootbox, alerts) {
    const AccountEdit = {};
