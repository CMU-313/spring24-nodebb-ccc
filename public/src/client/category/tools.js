...
define('forum/category/tools', ['topicSelect', 'forum/topic/threadTools', 'components', 'api', 'bootbox', 'alerts'], function (topicSelect, threadTools, components, api, bootbox, alerts) {
    const CategoryTools = {};
