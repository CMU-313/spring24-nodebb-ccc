...
define('forum/flags/list', ['components', 'Chart', 'categoryFilter', 'autocomplete', 'api', 'alerts'], function (components, Chart, categoryFilter, autocomplete, api, alerts) {
    const Flags = {};
    ...
    Flags.init = function () {
        ...
        if (ajaxify.data.filters.hasOwnProperty('cid')) {
            selectedCids = Array.isArray(ajaxify.data.filters.cid) ? ajaxify.data.filters.cid : [ajaxify.data.filters.cid];
        }
