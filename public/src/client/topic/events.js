...
define('forum/topic/events', ['forum/topic/postTools', 'forum/topic/threadTools', 'forum/topic/posts', 'forum/topic/images', 'components', 'translator', 'benchpress', 'hooks'], function (postTools, threadTools, posts, images, components, translator, Benchpress, hooks) {
    const Events = {};
    ...
    function togglePostReaction(data) {
        ...
        post.find('[component="post/reaction-text"]')
            .filter(function (index, el) {
