...
module.exports = function (Posts) {
    ...
    Posts.uploads.sync = async function (pid) {
        ...
        const [content, currentUploads, isMainPost] = await Promise.all([Posts.getPostField(pid, 'content'), Posts.uploads.list(pid), Posts.isMain(pid)]);
    ...
    Posts.uploads.associate = async function (pid, filePaths) {
        ...
        await Promise.all([db.sortedSetAdd(`post:${pid}:uploads`, scores, filePaths), db.sortedSetAddBulk(bulkAdd), Posts.uploads.saveSize(filePaths)]);
    };
