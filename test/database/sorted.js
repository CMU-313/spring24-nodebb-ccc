...
describe('Sorted Set methods', () => {
    ...
    describe('sortedSetIncrBy()', () => {
        ...
        it('should increment fields of sorted sets with a single call', async () => {
            ...
            assert.deepStrictEqual(await db.getSortedSetRangeWithScores('sortedIncrBulk1', 0, -1), [{ value: 'value1', score: 1 }]);
            assert.deepStrictEqual(await db.getSortedSetRangeWithScores('sortedIncrBulk2', 0, -1), [{ value: 'value2', score: 2 }]);
        ...
        it('should increment the same field', async () => {
            ...
            assert.deepStrictEqual(await db.getSortedSetRangeWithScores('sortedIncrBulk5', 0, -1), [{ value: 'value5', score: 10 }]);
        });
    });
    ...
    describe('sortedSetRemove()', () => {
        ...
        it('should not remove wrong elements in bulk remove', async () => {
            ...
            const members = await Promise.all([db.getSortedSetRange('bulkRemove4', 0, -1), db.getSortedSetRange('bulkRemove5', 0, -1)]);
    ...
    describe('sortedSetsRemove()', () => {
        before(done => {
            async.parallel([async.apply(db.sortedSetAdd, 'sorted4', [1, 2], ['value1', 'value2']), async.apply(db.sortedSetAdd, 'sorted5', [1, 2], ['value1', 'value3'])], done);
        });
